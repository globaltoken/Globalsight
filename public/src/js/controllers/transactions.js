...
angular.module('Globalsight.transactions').controller('transactionsController',
...
angular.module('Globalsight.transactions').controller('SendRawTransactionController',
  function($scope, $http) {
  $scope.transaction = '';
